...
<body class="hold-transition {{ auth()->user()->theme }} layout-fixed sidebar-mini"
    @if ($language == 'Arabic-ar') dir="rtl" @endif>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="{{ url('admin/') }}" class="brand-link">
                ...
                <span class="brand-text font-weight-light"
                    style="font-size: 30px;margin-left: 26px;font-family: emoji;">PTM
                    SERVICE</span>
            </a>
                ...
                <div class="form-inline">
                    <div class="input-group" data-widget="sidebar-search">
                        ...
                        <input class="form-control form-control-sidebar" type="search"
                            placeholder=" @lang('fleet.search')" aria-label="Search">
                            ...
                            @if (Auth::user()->user_type == 'D')
                                ...
                                <li class="nav-item">
                                    <a href="{{ url('admin/vehicle-inspection') }}"
                                        class="nav-link @if (Request::is('admin/vehicle-inspection*') ||
                                                Request::is('admin/view-vehicle-inspection*') ||
                                                Request::is('admin/print-vehicle-inspection*')) active @endif">
                                ...
                                @if (
                                    ...
                                    <li class="nav-item">
                                        <a href="{{ url('admin/chat/') }}"
                                            class="nav-link @if (Request::is('admin/chat')) active @endif">
                ...
                <a href="{{ url('admin/booking-expense')}}"
                  ...
                  <p>@lang('fleet.booking_expense')</p>
                            ...
                            @if (!Auth::guest() && Auth::user()->user_type != 'D' && Auth::user()->user_type != 'C')
                                ...
                                @canany(['Users list', 'Drivers list', 'Customer list'])
                                    <li class="nav-item has-treeview {{ $class }}">
                                        <a href="#" class="nav-link {{ $active }}">
                                            ...
                                            <p>
                                                Employee details <i class="right fa fa-angle-left"></i>
                                            </p>
                                        </a>
                                        <ul class="nav nav-treeview">
                                            <!--@can('Drivers list')-->
                                ...
                                @if (Request::is('admin/driver-logs') ||
                                ...
                                @canany([
                                    ...
                                    <li class="nav-item has-treeview {{ $class }}">
                                        ...
                                        <ul class="nav nav-treeview">
                                                 ...
                                                 <li class="nav-item">
                                                          <a href="{{ route('aglign.ment2') }}"
                                                    class="nav-link @if (Request::is('admin/fleet') || Request::is('admin/fleet')) active @endif">
                                            ...
                                            @can('Vehicles list')
                                                <li class="nav-item">
                                                    <a href="{{ route('vehicles.index') }}"
                                                        class="nav-link @if (Request::is('admin/vehicles') || Request::is('admin/vehicles/create') || Request::is('admin/vehicles/*/edit')) active @endif"
                  ...
                  @endcan --}}
                                            ...
                                            @endcan
                                                ...
                                                <a href="{{ route('expense.index') }}"
                                                    ...
                                                    <li class="nav-item">
                                                          <a href="{{ route('aglign.ment') }}"
                                                    class="nav-link @if (Request::is('admin/alignment') || Request::is('admin/alignment')) active @endif">
                                ...
                                @can('Reports list')
                                    <li class="nav-item has-treeview {{ $class }}">
                                        ...
                                        <!--     <li class="nav-item">-->
                                        <!--    <a href="{{ route('dreports.yearly') }}"-->
                                        <!--        class="nav-link @if (Request::is('admin/driver-reports/alignment')) active @endif">-->
                                        <!--        <i class="fa fa-calendar nav-icon"></i>-->
                                        <!--        <p>AlignMent Report</p>-->
                                        <!--    </a>-->
                                        <!--</li>-->
                                ...
                                @if (Request::is('admin/settings*') ||
                                        ...
                                        (Request::is('admin/chat-settings*') || Request::is('admin/traccar-settings')))
                                    @php($class = 'menu-open')
                                    @php($active = 'active')
                                @else
                                    @php($class = '')
                                ...
                                @if (Hyvikk::api('api_key') != null && Hyvikk::api('db_url') != null)
                                    <li class="nav-item">
                                ...
                                @if (Hyvikk::api('api') && Hyvikk::api('driver_review') == 1)
                                    <li class="nav-item">
                                        <a href="{{ url('admin/reviews') }}"
                                            class="nav-link @if (Request::is('admin/reviews')) active @endif">
                                ...
                                <!--                class="nav-link @if (Request::is('admin/messages')) active @endif">-->
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                @if (!Request::is('admin'))
                                    <li class="breadcrumb-item"><a href="{{ url('admin/') }}">@lang('fleet.home')</a>
                                    </li>
                                @endif
                                @yield('breadcrumb')
                            </ol>
        ...
        $(document).ready(function() {
            ...
            $('input[type="text"]').on('keypress', function(evt) {
                ...
                if (
                    ...
                    (inputId === "currency" && [36, 8364, 163, 165, 8377, 165, 8355, 8363].includes(
                        ASCIICode)) // Currency symbols
                ) {
                    return true;
                }
                return false;
            ...
            $("input[type=search]").on("input", function() {
                ...
                if (inputValue.length > 0) {
                    $(".nav-sidebar li").hide().filter(function() {
                        return $(this).text().toLowerCase().indexOf(inputValue.toLowerCase()) !== -
                            1;
                    }) //.show(); 
                } else {
                    $(".nav-sidebar li").show();
