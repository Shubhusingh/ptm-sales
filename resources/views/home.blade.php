            ...
            <div class="col-12 col-sm-6 col-md-3">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text">Active Supervisor</span>
                ...
                <div class="card-header">
                    <h3 class="card-title">@lang('fleet.yearly_chart')
                        <div class="pull-right">
                            {!! Form::select('year', $years, $year_select, [
                                'class' => 'form-control',
                                'style' => 'width:100px',
                                'id' => 'year',
                            ]) !!}
    ...
    preg_match(
        ...
        substr($useragent, 0, 4),
                    ...
                    @else
                        @php($height = '300')
                    @endif
                    <div class="chart"><canvas id="yearly" width="800" height="{{ $height }}"></canvas>
                    </div>
                </div>
            </div>
        </div>
