        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <div class="form-group">
             ...
             <div class="form-group">
              {!! Form::label('profile_image', __('Id Proof'), ['class' => 'form-label']) !!}

              {!! Form::file('idproof',null,['class' => 'form-control']) !!}
            </div>
          ...
          <div class="col-md-6">
            ...
            <div class="form-group">
              {!! Form::label('group_id',__('Select Type'), ['class' => 'form-label']) !!}
              <select id="group_id" name="" class="form-control">
