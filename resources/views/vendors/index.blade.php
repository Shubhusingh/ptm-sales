@extends("layouts.app")
@section("breadcrumb")
<li class="breadcrumb-item active">Add New Fitter </li>
@endsection
@section('extra_css')
<style type="text/css">
  .checkbox, #chk_all{
  ...
  <div class="col-md-12">
    ...
    <div class="card card-info">
      <div class="card-header">
        ...
        &nbsp;
       Fitter<a href="{{ route('vendors.create')}}" class="btn btn-success" title="Add New"><i class="fa fa-plus"></i></a>
        </h3>
      </div>
           ...
           @endphp
            ...
            <tr>
                ...
                <td>{{$value->photo ?? 0}}</td>
                    ...
                    <a href="{{ asset('photo/'.$value->photo) }}" download>
  Download
</a>
                 <td>{{$value->name ?? 0}}</td>
                <td>{{$value->phone ?? 0}}</td>
