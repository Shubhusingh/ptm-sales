  ...
  <div class="col-md-12">
    ...
    <div class="card card-success">
      <div class="card-header">
        <h3 class="card-title"> New Add Fleet</h3>
      </div>
      ...
      <div class="card-body">
        ...
        {!! Form::open(['route' => 'fleetstore','files'=>true,'method'=>'post']) !!}
            ...
            <div class="row card-body">
              <div class="col-md-6">
                  ...
                  <div class="col-xs-6">
                    {!! Form::text('fleetname', null,['class' => 'form-control','required']) !!}
                  </div>
                </div>
...
<label for="type_id" class="col-xs-5 control-label">Contract End Date *</label>
               ...
               <textarea id="w3review" class="form-control" name="address" rows="2" cols="50"></textarea>
                    </div>
                  </div>
                </div>
