  ...
  <div class="col-md-12">
    ...
    <div class="card card-success">
      <div class="card-header">
        <h3 class="card-title"> New Add Alignment</h3>
      </div>
      ...
      <div class="card-body">
        ...
        {!! Form::open(['route' => 'alignstore','files'=>true,'method'=>'post']) !!}
...
@endif
                  ...
                  <div class="col-xs-6">
                    {!! Form::text('searchno', null,['class' => 'form-control','required']) !!}
                  </div>
                </div>
...
<label for="type_id" class="col-xs-5 control-label">Date of Alignment</label>
                  <div class="col-xs-6">
   ...
   <div class="form-group">
                   ...
                   <label for="type_id" class="col-xs-5 control-label">Vehicle odometer</label>
                ...
                <div class="form-group">
                   ...
                   <label for="type_id" class="col-xs-5 control-label">Upload alignment report PDF/JGP</label>
