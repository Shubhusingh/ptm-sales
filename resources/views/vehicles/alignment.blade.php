        ...
        <div class="col-md-12">
            <div class="card card-info">
                <div class="card-header">
                    ...
                    <h3 class="card-title">Manage Alignment &nbsp; @can('Vehicles add')
                            <a href="{{route('aglignment.create')}}" class="btn btn-success" title="@lang('fleet.addNew')"><i
  ...
  Download
              ...
              {{$value->time ?? 0}}
                ...
                <td>
                                     ...
                                     <a href="{{route('tyre.delete',$value->id)}}"   onclick="return confirm('Are you sure you want to delete?');" class="btn btn-danger">Delete</a>
                </td>
