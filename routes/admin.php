 ...
 Route::get('test-login', 'Testcontroller@login');
    ...
    Route::group(['middleware' => ['lang_check', 'auth', 'officeadmin', 'IsInstalled']], function () {
        ...
        Route::post('delete-vehicle-reviews', 'VehiclesController@bulk_delete_reviews');
          Route::get('tyredelete/{id}', 'VehicleGroupController@destroy')->name('trye.delete');
        ...
        Route::get('/tryedelete/{id}', 'VehicleGroupController@fetch_data');


// alignment

 Route::get("/alignment", 'VehiclesController@alignment')->name('aglign.ment');
Route::get("/alignment_create", 'VehiclesController@alignment_store')->name('aglignment.create');
Route::post("alignmentcreatestore", 'VehiclesController@store_alignment')->name('alignstore');


//

// fleet
 Route::get("/fleet", 'VehiclesController@fleet')->name('aglign.ment2');
Route::get("/fleet_create", 'VehiclesController@fleet_store')->name('fleet.create');
Route::post("fleetcreatestore", 'VehiclesController@store_fleet')->name('fleetstore');
Route::get("/fleet_edit/{id}", 'VehiclesController@edit_fleet')->name('fleet.edit');
Route::post("fleet_update", 'VehiclesController@edit_fleet_update')->name('fleetupdate');
Route::get("fleetdelete/{id}", 'VehiclesController@fleetdelete')->name('fleet.delete');
Route::get("vehicledelete/{id}", 'VehiclesController@vehicledelete')->name('vehicle.delete');
Route::get("aginmentdelete/{id}", 'VehiclesController@alignmentdelete')->name('alignment.delete');
//
        ...
        Route::get("/reports/monthly", "ReportsController@monthly")->name("reports.monthly");
         Route::get("/reports/alignment", "ReportsController@monthly_alignment")->name("reports.alignment");
